...
// Public grocery-deals browser. Reads grocery_deals via the anon key
...
export default async function DealsPage({
  ...
  // By default only show deals that haven't expired.
  ...
  return (
    <div>
      ...
      <p className="mb-4 text-sm text-slate-500">
        Weekly flyer deals across your Maine stores, refreshed by the local agent.
      </p>
      ...
      <form method="get" className="card mb-6 grid gap-3 md:grid-cols-12">
        ...
        <div className="flex items-end gap-2 md:col-span-12">
          ...
          <a href="/deals" className="btn-secondary">Reset</a>
        </div>
      </form>
